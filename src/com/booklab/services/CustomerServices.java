...
//			st.setString(2, pass);
    ...
    public void updatepassemail(String pass, String email) {
        ...
        public boolean showemaildispo(String email) {
        
        try {
            String req = "select email from Customer " + "where email ='" + email + "'";
        ...
        public boolean showeuserdispo(String username) {

        try {
            String req = "select username from Customer " + "where username ='" + username + "'";
